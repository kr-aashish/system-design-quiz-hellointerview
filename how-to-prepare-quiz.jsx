...
export const QUESTIONS = [
  {
    ...
    "options": [
      ...
      "The two are roughly equivalent on retention but differ in style — Engineer X builds a broader mental library of patterns from observed designs, while Engineer Y builds depth on a smaller set. Under interview pressure either approach surfaces the right concepts, so the decisive variable is total hours invested rather than whether those hours were input-heavy or output-heavy.",
  ...
  },
  {
    ...
    "options": [
      ...
      "They skipped choosing a delivery framework. The framework provides structural scaffolding for the answer — without it, even fully-understood concepts can't be sequenced into a coherent design arc, so the candidate experiences the chaos of unstructured attempts as 'I don't recognize the terms' when the real issue is that the terms have no slot to occupy in their answer.",
      "They skipped the mock interview step at the start of the loop, not at the end. Mock interviews are where unfamiliar vocabulary gets rehearsed against a live interlocutor — without that early exposure, terms that seemed clear in articles feel completely foreign when an interviewer uses them under time pressure on attempt one, before any solo practice has built anchoring."
    ],
    "correctIndex": 1,
  ...
  },
  {
    ...
    "options": [
      "Candidate B — organic exploration tracks the actual shape of the problem rather than a generic checklist, so the time spent on the data model reflects genuine architectural depth in that area. The framework Candidate A used forces premature movement past important concerns just to hit a sequence; what looks like 'finishing' is really 'truncating the deep work the interviewer was waiting for.'",
      ...
      "Candidate A — the visible framework signals to the interviewer that the candidate has internalized a recognized industry methodology, which is itself a senior signal independent of design quality. Without the visible structure, even a strong design reads as 'lucky improvisation,' so the framework's primary value is the credibility halo it confers on the work it produces.",
      "Both reflect the case for a framework equally — A uses an explicit framework while B uses an implicit one shaped by experience, and under interview pressure both fall back to the same internalized step ordering. The difference between them is a matter of presentation style rather than substance, so the framework's actual value is purely as a communication aid for the interviewer."
    ],
    "correctIndex": 1,
  ...
  },
  {
    ...
    "options": [
      "They're under-investing in answer-key absorption. Fifteen minutes is enough to skim an answer key but not enough to internalize the trade-offs, so the candidate's subsequent attempt borrows the surface structure without the underlying reasoning. The corrected ordering keeps reading-first but stretches the answer-key phase to 30+ minutes, with the attempt acting as verification that the absorbed reasoning has stuck.",
      ...
      "The cycle's structure is fine but the feedback step is missing — mock interviews are the only mechanism that exposes whether 'I can follow this answer' has actually become 'I can produce this answer' under time pressure. Adding two mocks per week to the existing cycle would have caught the gap weeks earlier, since mock-interview signal is what calibrates self-evaluation against external reality.",
      "The re-read step is the cognitive failure — comparing your attempt to the answer key after just having read it 30 minutes earlier creates the illusion of consistency between the two. The corrected ordering eliminates the re-read entirely: read the answer once, attempt the design, and let a fresh mock-interview-style evaluation a week later expose what actually stuck versus what was familiarity-bias."
    ],
    "correctIndex": 1,
  ...
  },
  {
    ...
    "options": [
      ...
      "The candidate should synthesize their own custom framework by extracting the strongest step from each of the five they've read — a personalized sequence will fit their thinking style better than any off-the-shelf framework, and the synthesis exercise itself deepens their understanding of why each step exists. Once the custom framework is drafted, practice attempts can begin with full conviction in the structure.",
      "The candidate should pivot to memorizing canonical answer keys for the top 20 most-asked design questions, which provides direct interview-day leverage without depending on any specific framework. Frameworks help organize unfamiliar problems, but for the standard interview canon (Twitter, Uber, chat) the answer-key patterns are well-known enough that recall beats framework-driven derivation under time pressure."
    ],
    "correctIndex": 1,
  ...
  },
  {
    ...
    "options": [
      "Mock interviews replicate the time pressure of the real interview far more faithfully than self-paced solo practice. The 45-minute clock combined with another human waiting for output produces a cognitive load that solo practice cannot reproduce, and that cognitive load is itself the differentiating factor between candidates who perform well in practice and candidates who perform well in the actual interview when stakes are high. Self-evaluation from a written answer key cannot replicate this load.",
      ...
      "Mock interviews are the only setting in which the soft components of the interview get rehearsed: introductions, hypothesis-statement framing, the language used to ask clarifying questions, and the tonal calibration when admitting you don't know something. Technical answer keys cover the design content but never the conversational scaffolding around it, and these soft skills are where mid-level candidates routinely lose points despite producing technically correct designs in their solo practice.",
      "The mentor is over-indexing on a process step rather than the underlying signal it produces. Ten thoroughly-self-evaluated questions yields more genuine learning than two mocks plus eight rushed self-evaluations, because the depth of the self-evaluation is what creates retention. The candidate's discipline in completing 10 full attempts is itself a stronger readiness signal than any mock could provide, and saving the mock budget for late-stage calibration is the financially-rational choice."
    ],
    "correctIndex": 1,
  ...
  },
  {
    ...
    "options": [
      "The candidate hit a content-volume threshold problem rather than a method problem. SDE2-level system design prep typically needs ~200 hours of total study, and at 80 hours the candidate has only completed roughly 40% of the required surface area — the gaps in the Twitter design correspond to articles or canonical patterns they simply haven't encountered yet. The fix is to continue reading systematically (especially around Twitter-class problems specifically: feed generation, fanout strategies, hot-key handling) and the production skill will follow naturally as the recognition substrate becomes broad enough.",
